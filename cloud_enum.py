...
import argparse
import re
from osint_cloud import aws_checks
from osint_cloud import azure_checks
from osint_cloud import gcp_checks
from osint_cloud import utils

BANNER = '''
####################################################
                    cloud_enum
        Adding some changes in OSINT world
####################################################
...
def parse_arguments():
    ...
    """
    desc = "Multi-cloud enumeration utility OSINT!"
    ...
    parser.add_argument('-m', '--mutations', type=str, action='store',
                        default=script_path + '/osint_cloud/fuzz.txt',
                        help='Mutations. Default: osint_cloud/fuzz.txt')
